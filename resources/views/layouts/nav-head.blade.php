      ...
      <div class="navbar navbar-expand-lg landing-navbar border-top-0 px-3 px-md-4">
        ...
        <div class="navbar-brand app-brand demo d-flex py-0 py-lg-2 me-4">
          ...
          <a href="landing-page.html" class="app-brand-link">
            <img src="assets/img/logo_blanco_MC.png" class="app-brand" alt="logo MC"
              data-aos="fade-down"
              data-aos-delay="0"
              style="width: 100px;"
            />
        ...
        <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav me-auto p-3 p-lg-0">
            <li class="nav-item">
              <a class="nav-link fw-medium" aria-current="page" href="Top-ini">Inicio</a>
            </li>
            <li class="nav-item">
              <a class="nav-link fw-medium" href="#servicios">Servicios</a>
            </li>
            <li class="nav-item">
              <a class="nav-link fw-medium" href="#proyectos">Proyectos</a>
            </li>
            <li class="nav-item">
              <a class="nav-link fw-medium text-nowrap" href="#contacto">Contáctame</a>
            </li>
          </ul>
        </div>
